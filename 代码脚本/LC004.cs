...
public class LC004 : BattleListenerCase_1
{
	...
	public override void OnTrue()
	{
		...
		{
			publicSign = 0;
			component.center = GameObject.Find("enemy1_0");
			return;
		}
		if (startTime == -1f)
		{
		...
		{
			cct.GetComponent<Transform>().position = (tl - num) / tl * stv + num / tl * GameObject.Find("enemy1_0").GetComponent<Transform>().position;
		}
	}
}
